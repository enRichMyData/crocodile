...
class CrocodileResultFetcher:
    ...
    def __init__(self, client_id: str, dataset_name: str, table_name: str, **kwargs):
        """
    ...
    def get_results(self, row_ids: Optional[Union[int, List[int]]] = None) -> List[Dict]:
        ...
        Returns:
            A list of dictionaries containing the raw entity linking results
            for the specified row_ids,
        ...
        projection = {"el_results": 1, "row_id": 1, "status": 1, "ml_status": 1}
